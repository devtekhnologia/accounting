                  ...
                  <CCol style={{ marginLeft: "11px" }}>
                    <CRow className='allfirms_icon_title_row align-items-center'>
                      ...
                      <CCol className='col-10 col-md-7'>
                        <h5 className="title_font mb-0" style={{ color: 'white' }}>All Payments</h5>
                      </CCol>
                    </CRow>
                  </CCol>
                  <CCol className="col-6 makepay_allpay_but_col">
                    <Link to={'/make_payment'}>
                      <CButton id="but_color" className='m-0'>Make Payment</CButton>
                    </Link>
                  </CCol>
                </CRow>
