  ...
  useEffect(() => {
    const fetchFirms = async () => {
      try {
        ...
        setSelectedFirmId((resdata.data).map((defaultFirmId) => (defaultFirmId.firm_id)))
      } catch (error) {
                    ...
                    <CCol style={{ marginLeft: "11px" }} className='col-10'>
                      <CRow className='allfirms_icon_title_row align-items-center'>
                        ...
                        <CCol className='col-7 col-md-7'>
                          <h5 className="title_font mb-0" style={{ color: 'white' }}>Complete Report</h5>
                        </CCol>
                      </CRow>
                    </CCol>
                  </CRow>
                      ...
                      <CRow className='justify-content-center mb-3'>
                        ...
                        {/* <CCol className="allpay_datefil_col">
                          <DatePicker
                            ...
                            onChange={(date) => setSelectedMonth(date || new Date())} // Update only if a month is selected
                            dateFormat="MM/yyyy"
                            showMonthYearPicker
...
export default User_Complete_Report;
