...
import { CButton, CCard, CCol, CImage, CRow, CSpinner } from '@coreui/react';
                    ...
                    <CCol style={{ marginLeft: "11px" }} className='col-10'>
                      <CRow className='allfirms_icon_title_row align-items-center'>
                        ...
                        <CCol className='col-7 col-md-7'>
                          <h5 className="title_font mb-0" style={{ color: 'white' }}>Firm Report</h5>
                        </CCol>
                      </CRow>
                    </CCol>
...
export default User_Firm_Transactions;