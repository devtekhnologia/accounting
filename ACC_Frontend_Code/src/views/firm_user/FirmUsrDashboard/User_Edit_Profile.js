...
const SHOW_USER_DETAILS_API_URL = `http://43.205.145.172:3007/api/users/user_details/`;
const UPDATE_USER_DETAILS_API_URL = `http://43.205.145.172:3007/api/users/update_user_details/`;
